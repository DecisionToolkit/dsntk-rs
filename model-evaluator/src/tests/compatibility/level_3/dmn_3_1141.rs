...
fn _0007() {
  ...
  let expected = "null([core::round up] invalid argument type, expected number, actual type is Null)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
#[test]
fn _0008() {
...
fn _0014() {
  ...
  let expected = "null([core::round up] invalid argument type, expected number, actual type is string)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
#[test]
fn _0015() {
...
fn _0018() {
  ...
  let expected = "null([core::round_up] <FeelNumberError> invalid scale, allowed range is -6111..6144, actual is -6112)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
#[test]
fn _0019() {
...
fn _0020() {
  ...
  let expected = "null([core::round_up] <FeelNumberError> invalid scale, allowed range is -6111..6144, actual is 6177)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
#[test]
fn _0021() {
