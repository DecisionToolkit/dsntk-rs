...
fn _0007() {
  ...
  let expected = "null([core::round down] invalid argument type, expected number, actual type is Null)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
...
fn _0014() {
  ...
  let expected = "null([core::round down] invalid argument type, expected number, actual type is string)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
...
fn _0018() {
  ...
  let expected = "null([core::round_down] <FeelNumberError> invalid scale, allowed range is -6111..6144, actual is -6112)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
...
fn _0020() {
  ...
  let expected = "null([core::round_down] <FeelNumberError> invalid scale, allowed range is -6111..6144, actual is 6177)";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, invocable, &CTX, expected);
}
