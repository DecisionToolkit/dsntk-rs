...
#[test]
fn _0012() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, "null_001", &CTX, r#"null([core::day of year] invalid argument type, expected date, date and time, actual type is Null)"#);
}
...
#[test]
fn _0014() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, "null_003", &CTX, r#"null([core::day of year] invalid argument type, expected date, date and time, actual type is string)"#);
}

#[test]
fn _0015() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, "null_004", &CTX, r#"null([core::day of year] invalid argument type, expected date, date and time, actual type is Null)"#);
}

#[test]
fn _0016() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, "null_005", &CTX, r#"null([core::day of year] invalid argument type, expected date, date and time, actual type is string)"#);
}
...
fn _0018() {
  ...
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, &MODEL_NAME, "null_007", &ctx, r#"null([core::day of year] invalid argument type, expected date, date and time, actual type is string)"#);
}
