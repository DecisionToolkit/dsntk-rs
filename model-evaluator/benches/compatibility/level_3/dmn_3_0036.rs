...
fn _0001(b: &mut Bencher) {
  ...
  iter!(b, MODEL_EVALUATOR.evaluate_invocable(&MODEL_NAMESPACE, &MODEL_NAME, invocable_name, &CTX1));
}
...
fn _0009(b: &mut Bencher) {
  ...
  iter!(b, MODEL_EVALUATOR.evaluate_invocable(&MODEL_NAMESPACE, &MODEL_NAME, invocable_name, &CTX2));
}
...
fn _0017(b: &mut Bencher) {
  ...
  iter!(b, MODEL_EVALUATOR.evaluate_invocable(&MODEL_NAMESPACE, &MODEL_NAME, invocable_name, &CTX3));
}
