...
impl Namespaces {
  ...
  fn is_valid(&self, uri: &str) -> bool {
    self.dmn.as_ref().map(|v| v == uri).unwrap_or(false) || self.dmndi.as_ref().map(|v| v == uri).unwrap_or(false) || self.dc.as_ref().map(|v| v == uri).unwrap_or(false) || self.di.as_ref().map(|v| v == uri).unwrap_or(false)
  }
}
...
impl SchemaValidator {
  ...
  fn new() -> Self {
    Self { namespaces: Namespaces::default(), dmn_version: DmnVersion::V13 }
  }
...
mod v13 {
  ...
  pub const V_DEFINITIONS: ([&str; 2], [&str; 8], [&str; 0], [&str; 16]) = ([ATTR_NAME, ATTR_NAMESPACE], [ATTR_EXPORTER, ATTR_EXPORTER_VERSION, ATTR_EXPRESSION_LANGUAGE, ATTR_ID, ATTR_LABEL, ATTR_NAME, ATTR_NAMESPACE, ATTR_TYPE_LANGUAGE], [], [NODE_ASSOCIATION, NODE_BUSINESS_KNOWLEDGE_MODEL, NODE_DECISION, NODE_DECISION_SERVICE, NODE_DESCRIPTION, NODE_DMNDI, NODE_ELEMENT_COLLECTION, NODE_EXTENSION_ELEMENTS, NODE_GROUP, NODE_IMPORT, NODE_INPUT_DATA, NODE_ITEM_DEFINITION, NODE_KNOWLEDGE_SOURCE, NODE_ORGANISATION_UNIT, NODE_PERFORMANCE_INDICATOR, NODE_TEXT_ANNOTATION]);

  pub const V_ITEM_DEFINITION: ([&str; 1], [&str; 5], [&str; 0], [&str; 6]) = ([ATTR_NAME], [ATTR_ID, ATTR_LABEL, ATTR_NAME, ATTR_TYPE_LANGUAGE, ATTR_IS_COLLECTION], [], [NODE_ALLOWED_VALUES, NODE_DESCRIPTION, NODE_EXTENSION_ELEMENTS, NODE_FUNCTION_ITEM, NODE_ITEM_COMPONENT, NODE_TYPE_REF]);

  pub const V_DECISION: ([&str; 1], [&str; 3], [&str; 0], [&str; 21]) = ([ATTR_NAME], [ATTR_ID, ATTR_LABEL, ATTR_NAME], [], [NODE_ALLOWED_ANSWERS, NODE_AUTHORITY_REQUIREMENT, NODE_CONTEXT, NODE_DECISION_MAKER, NODE_DECISION_OWNER, NODE_DECISION_TABLE, NODE_DESCRIPTION, NODE_EXTENSION_ELEMENTS, NODE_FUNCTION_DEFINITION, NODE_IMPACTED_PERFORMANCE_INDICATOR, NODE_INFORMATION_REQUIREMENT, NODE_INVOCATION, NODE_KNOWLEDGE_REQUIREMENT, NODE_LIST, NODE_LITERAL_EXPRESSION, NODE_QUESTION, NODE_RELATION, NODE_SUPPORTED_OBJECTIVE, NODE_USING_PROCESS, NODE_USING_TASK, NODE_VARIABLE]);

  pub const V_BUSINESS_KNOWLEDGE_MODEL: ([&str; 1], [&str; 3], [&str; 0], [&str; 6]) = ([ATTR_NAME], [ATTR_ID, ATTR_LABEL, ATTR_NAME], [], [NODE_AUTHORITY_REQUIREMENT, NODE_DESCRIPTION, NODE_ENCAPSULATED_LOGIC, NODE_EXTENSION_ELEMENTS, NODE_KNOWLEDGE_REQUIREMENT, NODE_VARIABLE]);

  pub const V_DECISION_SERVICE: ([&str; 1], [&str; 3], [&str; 0], [&str; 7]) = ([ATTR_NAME], [ATTR_ID, ATTR_LABEL, ATTR_NAME], [], [NODE_INPUT_DATA, NODE_DESCRIPTION, NODE_ENCAPSULATED_DECISION, NODE_EXTENSION_ELEMENTS, NODE_INPUT_DECISION, NODE_OUTPUT_DECISION, NODE_VARIABLE]);

  pub const V_INPUT_DATA: ([&str; 1], [&str; 3], [&str; 0], [&str; 3]) = ([ATTR_NAME], [ATTR_ID, ATTR_LABEL, ATTR_NAME], [], [NODE_DESCRIPTION, NODE_EXTENSION_ELEMENTS, NODE_VARIABLE]);
}

mod v14 {
  use crate::xml_utils::*;

  pub const V_DECISION: ([&str; 1], [&str; 3], [&str; 0], [&str; 26]) = ([ATTR_NAME], [ATTR_ID, NODE_AUTHORITY_REQUIREMENT, ATTR_NAME], [], [NODE_ALLOWED_ANSWERS, NODE_AUTHORITY_REQUIREMENT, NODE_CONDITIONAL, NODE_CONTEXT, NODE_DECISION_MAKER, NODE_DECISION_OWNER, NODE_DECISION_TABLE, NODE_DESCRIPTION, NODE_EVERY, NODE_EXTENSION_ELEMENTS, NODE_FILTER, NODE_FOR, NODE_FUNCTION_DEFINITION, NODE_IMPACTED_PERFORMANCE_INDICATOR, NODE_INFORMATION_REQUIREMENT, NODE_INVOCATION, NODE_KNOWLEDGE_REQUIREMENT, NODE_LIST, NODE_LITERAL_EXPRESSION, NODE_QUESTION, NODE_RELATION, NODE_SOME, NODE_SUPPORTED_OBJECTIVE, NODE_USING_PROCESS, NODE_USING_TASK, NODE_VARIABLE]);
}
