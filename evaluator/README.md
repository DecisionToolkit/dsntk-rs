...
# FEEL expressions and DMN models evaluator
...
FEEL expressions and DMN models evaluator used by other components of [Decision Toolkit](https://crates.io/crates/dsntk).
