...
#[test]
fn _0012() {
  te_null(false, &scope!(), r#" @"P10D" / 0.00000000000000000000000000000000000000000000000001 "#, r#"[division] error: P10D / 0.00000000000000000000000000000000000000000000000001"#);
}
...
#[test]
fn _0017() {
  te_null(false, &scope!(), r#" @"P10Y" / 0.00000000000000000000000000000000000000000000000001 "#, r#"[division] error: P10Y / 0.00000000000000000000000000000000000000000000000001"#);
}
