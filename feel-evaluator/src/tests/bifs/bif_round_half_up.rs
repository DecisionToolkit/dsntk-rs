...
#[test]
fn _0024() {
  te_number(false, &scope!(), "round half up(1.122, 2)", 112, 2);
}

#[test]
fn _0025() {
  te_number(false, &scope!(), "round half up(1.123, 2)", 112, 2);
}

#[test]
fn _0026() {
  te_number(false, &scope!(), "round half up(1.124, 2)", 112, 2);
}

#[test]
fn _0027() {
  te_number(false, &scope!(), "round half up(1.125, 2)", 113, 2);
}

#[test]
fn _0028() {
  te_number(false, &scope!(), "round half up(1.126, 2)", 113, 2);
}

#[test]
fn _0029() {
  te_number(false, &scope!(), "round half up(1.127, 2)", 113, 2);
}

#[test]
fn _0030() {
  te_number(false, &scope!(), "round half up(1.128, 2)", 113, 2);
}

#[test]
fn _0031() {
  te_number(false, &scope!(), "round half up(1.129, 2)", 113, 2);
}
...
#[test]
fn _0041() {
  te_number(false, &scope!(), "round half up(n: -1.129, scale: 2)", -113, 2);
}

#[test]
fn _0042() {
  te_null(false, &scope!(), "round half up(1.1, 0, 5)", "expected 2 parameters, actual number of parameters is 3");
}

#[test]
fn _0043() {
  te_null(false, &scope!(), "round half up()", "expected 2 parameters, actual number of parameters is 0");
}

#[test]
fn _0044() {
  te_null(false, &scope!(), "round half up(num: 1.23, scale: 1)", "parameter 'n' not found");
}

#[test]
fn _0045() {
  te_null(false, &scope!(), "round half up(n: 1.23, s: 1)", "parameter 'scale' not found");
}
...
fn _0047() {
  ...
  //--------------------------------------------------------------------------------------------------------------------
  te_number(false, &scope!(), "round half up(5.5, 6144)", 55, 1);
}
...
fn _0048() {
  ...
  //--------------------------------------------------------------------------------------------------------------------
  te_number(false, &scope!(), "round half up(5.5, -6111)", 0, 0);
}
