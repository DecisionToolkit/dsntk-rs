...
#[test]
fn _0006() {
  te_be_value(false, &scope!(), r#"for x in [1,2,3], y in [6,7,8], z in [-1,-2,-3] return x + y + z"#, "[6,5,4,7,6,5,8,7,6,7,6,5,8,7,6,9,8,7,8,7,6,9,8,7,10,9,8]");
}
...
#[test]
fn _0008() {
  te_be_value(false, &scope!(), r#"for i in 1..3, j in [4,5] return {a: i, b: j}"#, "[{a: 1, b: 4}, {a: 1, b: 5}, {a: 2, b: 4}, {a: 2, b: 5}, {a: 3, b: 4}, {a: 3, b: 5}]");
}

#[test]
fn _0009() {
  te_be_value(false, &scope!(), r#"for j in [4,5], i in 1..3 return {a: i, b: j}"#, "[{a: 1, b: 4}, {a: 2, b: 4}, {a: 3, b: 4}, {a: 1, b: 5}, {a: 2, b: 5}, {a: 3, b: 5}]");
}
...
fn _0014() {
  ...
  //--------------------------------------------------------------------------------------------------------------------
  te_be_value(false, &scope!(), "for x in [[1,2],[3,4]], y in x, z in [8,9,10] return y", "[1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4]");
}
...
fn _0022() {
  ...
  //--------------------------------------------------------------------------------------------------------------------
  te_be_value(false, &scope!(), "for x in [[[1,2],[3,4]],[[5,6],[7,8]]], y in x, z in y return z", "[1, 2, 3, 4, 5, 6, 7, 8]");
}
