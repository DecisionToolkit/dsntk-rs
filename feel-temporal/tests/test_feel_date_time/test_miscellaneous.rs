...
fn _0002() {
  ...
  assert_eq!("<TemporalError> invalid date and time literal '999999999-01-10T24:00:00'", date_time.err().unwrap().to_string());
}
...
fn _0004() {
  ...
  assert_eq!("<TemporalError> invalid date and time literal '2023-02-09T24:01:00@Europe/Sofa'", date_time.err().unwrap().to_string());
}
...
fn _0007() {
  ...
  assert_eq!("<TemporalError> invalid date and time literal '99999999-01-01T00:00:00'", date_time.err().unwrap().to_string());
}

#[test]
fn _0008() {
  let date_time: dsntk_common::Result<FeelDateTime> = "-99999999-12-31T00:00:00".try_into();
  assert_eq!("<TemporalError> invalid date and time literal '-99999999-12-31T00:00:00'", date_time.err().unwrap().to_string());
}
